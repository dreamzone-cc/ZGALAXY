...
planetRouter.post('/build', async (req, res, next) => {
  try {
...
planetRouter.post('/regenerate', async (req, res, next) => {
  try {
    const result = await PlanetService.buildPlanet(req.body);
    res.json(result);
  } catch (err) {
...
planetRouter.delete('/', async (req, res, next) => {
  try {
...
planetRouter.post('/validate', async (req, res, next) => {
  try {
